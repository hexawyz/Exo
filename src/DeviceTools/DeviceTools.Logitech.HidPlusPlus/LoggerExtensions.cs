...
internal static partial class LoggerExtensions
{
	...
	[LoggerMessage(
		...
		Message = "Device {DeviceSerialNumber} has control {ControlId:X4} (Task: {TaskId:X4}, Position: {Position}, GroupNumber: {GroupNumber}, GroupMask: {GroupMask}, Flags: {Flags}, Capabilities: {ReportingCapabilities}).")]
	...
	[LoggerMessage(
		EventId = 65009,
		Level = LogLevel.Debug,
		Message = "Device {DeviceSerialNumber} has control {ControlId:X4} (Task: {TaskId:X4}, GroupNumber: {GroupNumber}, GroupMask: {GroupMask}, Flags: {Flags}, Capabilities: {ReportingCapabilities}).")]
	...
	[LoggerMessage(
		EventId = 65010,
		Level = LogLevel.Debug,
		Message = "Device {DeviceSerialNumber} has control {ControlId:X4} (Task: {TaskId:X4}, Position: {Position}, Flags: {Flags}, Capabilities: {ReportingCapabilities}).")]
	...
	[LoggerMessage(
		EventId = 65011,
		Level = LogLevel.Debug,
		Message = "Device {DeviceSerialNumber} has control {ControlId:X4} (Task: {TaskId:X4}, Flags: {Flags}, Capabilities: {ReportingCapabilities}).")]
