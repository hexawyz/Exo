...
public readonly partial struct MultiColorBreathingEffect(in FixedList2<RgbColor> colors) :
	ILightingEffect,
	IConvertibleLightingEffect<ColorBreathingEffect, MultiColorBreathingEffect>
{
	[Display(Name = "Colors")]
	[Array(1, 2)]
	[DefaultValue("#00FF00,")]
	...
	public static implicit operator MultiColorBreathingEffect(in ColorBreathingEffect effect)
		=> new([effect.Color]);
}
