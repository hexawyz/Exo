...
public readonly partial struct RandomColorPulseEffect : ISingletonLightingEffect
{
	/// <summary>Gets a boxed instance of the effect.</summary>
	public static ISingletonLightingEffect SharedInstance { get; } = new RandomColorPulseEffect();
}
