...
public readonly partial struct CoveringMarqueeEffect(in FixedList8<RgbColor> colors, PredeterminedEffectSpeed speed, EffectDirection1D direction) : ILightingEffect
{
	[Display(Name = "Colors")]
	[Array(1, 8)]
