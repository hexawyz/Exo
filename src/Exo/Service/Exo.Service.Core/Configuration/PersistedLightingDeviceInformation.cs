...
internal readonly struct PersistedLightingDeviceInformation(BrightnessCapabilities? brightnessCapabilities, Guid? unifiedLightingZoneId, LightingPersistenceMode persistenceMode, LightingCapabilities capabilities)
{
	...
	public LightingCapabilities Capabilities { get; } = capabilities;
}
