...
internal static partial class LoggerExtensions
{
	...
	[LoggerMessage(EventId = 2001, Level = LogLevel.Error, Message = "An error occurred when processing an incoming message on the HID I2C interface.")]
	public static partial void HidI2CTransportMessageProcessingError(this ILogger logger, Exception exception);
