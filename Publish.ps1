...
Try
{
	...
	MSBuild .\Exo.Settings.Ui\Exo.Settings.Ui.csproj /t:Publish /p:Configuration=Release /p:RuntimeIdentifier=win-x64
	...
	Copy-Item -Path "Exo.Settings.Ui\bin\Release\net8.0-windows10.0.22621.0\win-x64\publish" -Destination "publish\Exo.Settings.Ui" -Recurse
