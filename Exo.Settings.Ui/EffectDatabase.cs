...
internal class EffectDatabase
{
	...
	private static readonly Dictionary<Guid, string> EffectNames = new()
	{
		...
		{ new(0xF64133DF, 0x043A, 0x4E9F, 0x82, 0xCA, 0x64, 0x89, 0xB8, 0xF7, 0x86, 0xA7), "Color Wave" },
		{ new(0x3798FD63, 0x6B69, 0x4167, 0xAD, 0x09, 0xB0, 0x06, 0x20, 0x82, 0x17, 0x8C), "Color Wave (Speed)" },
