...
{
	[LoggerMessage(EventId = 1001, Level = LogLevel.Error, Message = "An exception occurred.")]
	public static partial void RegisterAccessReceiverDeviceUnhandledException(this ILogger logger, Exception exception);

	[LoggerMessage(EventId = 1002, Level = LogLevel.Error, Message = "An exception occurred in the {deviceEventKind} handler.")]
	...
	[LoggerMessage(EventId = 1101, Level = LogLevel.Error, Message = "An exception occurred while handling the HID++ 2.0 event {eventId} of feature {feature}.")]
